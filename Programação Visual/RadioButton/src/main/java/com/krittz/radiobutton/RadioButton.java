...
public class RadioButton extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(133, 14, 109));

        radioAzul.setFont(new java.awt.Font("Fira Code", 1, 18)); // NOI18N
        ...
        radioVermelho.setFont(new java.awt.Font("Fira Code", 1, 18)); // NOI18N
        radioVermelho.setForeground(new java.awt.Color(255, 0, 0));
        ...
        textField.setText("MUDE A COR DO TEXTO");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(71, 71, 71)
                .addComponent(radioAzul, javax.swing.GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(radioAzul, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(radioVermelho))
                .addGap(121, 121, 121))
        );
    ...
    private void radioVermelhoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioVermelhoActionPerformed
       if(radioVermelho.isSelected()){
            textField.setForeground(new java.awt.Color(255, 0, 0));
        }else{
            textField.setForeground(new java.awt.Color(0, 0,0));
        }
       
       if(radioVermelho.isSelected() && radioAzul.isSelected()){
           textField.setForeground(new java.awt.Color(214, 210, 19));
       }
    ...
    private void radioAzulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioAzulActionPerformed
        if(radioAzul.isSelected()){
            textField.setForeground(new java.awt.Color(0, 51, 225));
        }else{
            textField.setForeground(new java.awt.Color(0, 0,0));
        }
        if(radioVermelho.isSelected() && radioAzul.isSelected()){
